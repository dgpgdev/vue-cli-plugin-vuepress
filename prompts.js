module.exports = [
	...
	},
	{
		...
		choices: [ 'github', 'gitlab', 'firebase' ],
		default: 'github',
	...
	},
	{
		...
		default: 1,
		when: (answers) => answers.deploy && answers.repotype === ('github' || 'gitlab'),
	},
	{
		type: 'input',
		name: 'repo_name',
	...
	},
	{
		type: 'input',
		name: 'firebaseID',
		message: 'Insert your firebase ID',
		when: (answers) => answers.deploy && answers.repotype === 'firebase',
	},
